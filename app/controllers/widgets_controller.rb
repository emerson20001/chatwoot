...
class WidgetsController < ActionController::Base
  ...
  before_action :apply_branding_overrides_to_global_config
  ...
  def apply_branding_overrides_to_global_config
    return if @global_config.blank?

    @global_config = apply_branding_overrides(@global_config, request.host)
  end
